...
class MALA_Sampler
{
  ...
  public:
  MALA_Sampler(RandomVariable* rand_var,Real gamma, int no_iter,Real*init_val):rand_var(rand_var),gamma(gamma),no_iter(no_iter),init_val(init_val),n(rand_var->dim()),U(0,1)
  {
